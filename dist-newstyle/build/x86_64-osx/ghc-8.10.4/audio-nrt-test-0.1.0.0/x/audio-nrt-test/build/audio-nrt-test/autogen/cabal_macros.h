...
/* package audio-nrt-test-0.1.0.0 */
#ifndef VERSION_audio_nrt_test
#define VERSION_audio_nrt_test "0.1.0.0"
#endif /* VERSION_audio_nrt_test */
#ifndef MIN_VERSION_audio_nrt_test
#define MIN_VERSION_audio_nrt_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_audio_nrt_test */
...
#define CURRENT_COMPONENT_ID "audio-nrt-test-0.1.0.0-inplace-audio-nrt-test"
